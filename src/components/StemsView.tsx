...
import { formatTextWithTags, getCleanSongNameWithTags, matchesFilters, createSlug, getSongSlug, ALBUM_RELEASE_DATES, isSongNotAvailable, CUSTOM_IMAGES, handleDownloadFile } from '../utils';
    ...
    return (
      <>
        ...
        <motion.div
          ...
          className="absolute inset-0 z-10 bg-yzy-black overflow-y-auto pb-32"
        >
